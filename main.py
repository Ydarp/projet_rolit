...
if __name__ == '__main__':
    ...
    while k < nb_m:
        ...
        while sum(compte_couleur(t).values()) != 64:
            ...
            x, y = int(input("Quel est la coordonnée verticale de la couleur jouée - ")), int(input("Quel est la coordonnée horizontale de la couleur jouée - "))
